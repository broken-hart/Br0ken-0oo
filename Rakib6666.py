# Decompiled broken-hart
# Ablami mat kar na agli Bar mera file lekar
# Bangladesh-Hacker = Mr.Rakib
try:
...
def mk1():
    ...
    print '\x1b[94;1m  [4]  Friendlist Cloning'
    print '\x1b[91;1m  [5]  2010 ID Cloning'
    print '\x1b[91;1m  [6]  2009 ID Cloning'
    print '\x1b[92;1m  [7]  2008-2007 ID Cloning'
  Cloning'''
    mk_select1()
...
def mk2():
    ...
    print '\x1b[95;1m  [3]  File Cloning'
    print '\x1b[93;1m  [4]  Friendlist Cloning'
    print '\x1b[90;1m  [5]  2010 ID Cloning'
    print '\x1b[92;1m  [6]  2009 ID Cloning'
    print '\x1b[91;1m  [7]  2008 ID Cloning'
    print '\x1b[91;1m  [8]  2007 ID Cloning' 
    print ''
    mk2_select()
...
def ex_id():
    ...
    print '\x1b[91;1m Saved /facebook/old/ids.txt'
    print ''
    time.sleep(1)
    ex_id()


if __name__ == '__rakib__':
    main()